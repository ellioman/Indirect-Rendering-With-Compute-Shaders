	...
	SubShader
	{
		...
		UNITY_DECLARE_TEX2DARRAY(_MainTexArray);
			...
			void setup()
			{
				...
				float scale = instance.uniformScale * 1.;
				...
				unity_ObjectToWorld = translation;//mul(translation, rotMatrix);
		...
		void surf(Input IN, inout SurfaceOutput o) 
		{
			...
			// o.Albedo = UNITY_SAMPLE_TEX2DARRAY(_MainTexArray, float3(IN.uv_MainTex, 0)).rgb;
			#else
